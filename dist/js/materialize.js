/*!
 * Materialize v1.1.0 (http://materializecss.com)
...
;(function ($) {
  ...
  var Autocomplete = function (_Component2) {
    ...
    function Autocomplete(el, options) {
      ...
      var _this7 = _possibleConstructorReturn(this, (Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call(this, Autocomplete, el, options));

      _this7.el.M_Autocomplete = _this7;
       ...
       */
      _this7.options = $.extend({}, Autocomplete.defaults, options);
      ...
      _this7.oldVal;
      _this7.$inputField = _this7.$el.closest('.input-field');
      _this7.$active = $();
      _this7._mousedown = false;
      _this7._setupDropdown();
    ...
    _createClass(Autocomplete, [{
      ...
      value: function _highlight(string, $el) {
        ...
        $el.html("<span data=\"" + data + "\">" + beforeMatch + "<span class='highlight'>" + matchText + "</span>" + afterMatch + "</span>");
        if (img.length) {
          $el.prepend(img);
        }
      }
      ...
      value: function _renderDropdown(data, val) {
        ...
        if (this.options.sortFunction) {
          var sortFunctionBound = function (a, b) {
            return _this9.options.sortFunction(a.key.toLowerCase(), b.key.toLowerCase(), val.toLowerCase());
          };
        ...
        for (var i = 0; i < matchingData.length; i++) {
          ...
          if (!!_entry.data && !this.options.useCustomData) {
            $autocompleteOption.append("<img src=\"" + _entry.data + "\" class=\"right circle\"><span>" + _entry.key + "</span>");
          } else if (this.options.useCustomData) {
            var stringData = JSON.stringify(_entry.data);
            $autocompleteOption.append("<span data=\"" + stringData + "\">" + _entry.key + "</span>");
          } else {
...
;(function ($) {
  ...
  var Chips = function (_Component3) {
    _inherits(Chips, _Component3);
    ...
    function Chips(el, options) {
      ...
      var _this10 = _possibleConstructorReturn(this, (Chips.__proto__ || Object.getPrototypeOf(Chips)).call(this, Chips, el, options));

      _this10.el.M_Chips = _this10;
       ...
       */
      _this10.options = $.extend({}, Chips.defaults, options);

      _this10.$el.addClass('chips input-field');
      _this10.chipsData = [];
      _this10.$chips = $();
      _this10._setupInput();
      _this10.hasAutocomplete = Object.keys(_this10.options.autocompleteOptions).length > 0;

      // Set input id
      if (!_this10.$input.attr('id')) {
        _this10.$input.attr('id', M.guid());
      }

      // Render initial chips
      if (_this10.options.data.length) {
        _this10.chipsData = _this10.options.data;
        _this10._renderChips(_this10.chipsData);
      }

      // Setup autocomplete if needed
      if (_this10.hasAutocomplete) {
        _this10._setupAutocomplete();
      }

      _this10._setPlaceholder();
      _this10._setupLabel();
    ...
    _createClass(Chips, [{
      ...
      value: function _setupAutocomplete() {
        ...
        this.options.autocompleteOptions.onAutocomplete = function (event) {
          _this11.addChip({
            tag: event.value,
            data: event.data
          });
          _this11.$input[0].value = '';
          _this11.$input[0].focus();
        };
